...
{
	std::cout << "Intersect triangle with circle" << std::endl;
...
bool Triangle::intersectWithTriangle(const Triangle*) const
{
	std::cout << "Intersect triangle with triangle" << std::endl;
...
bool Triangle::intersectWithRectangle(const Rectangle*) const
{
	std::cout << "Intersect triangle with rectangle" << std::endl;
